const IMAGES = {
  appLogo: require('../../assets/images/walkthrough/AppLogo.png'),
  deliveryHero: require('../../assets/images/walkthrough/delivery-hero.png'),
  earnHero: require('../../assets/images/walkthrough/earn-hero.png'),
  figmaReferenceEarn: require('../../assets/images/walkthrough/figma-reference-earn.png'),
